...
bool find_input_sigs() noexcept {
    ...
    const short input_yaw_sig[] = { 0xD9, 0x5F, 0x0C, 0x0F, 0x84, 0xDB, 0x01, 0x00, 0x00, 0x8B, 0x0D, 0x10, 0xB7, 0x7F, 0x00 };
    add_signature_s2(input_yaw_sig);

    const short input_pitch_1_sig[] = { 0xD9, 0x57, 0x10, 0xDF, 0xE0, 0xF6, 0xC4, 0x05, 0x7A, 0x13, 0x8B, 0x47, 0x38 };
    add_signature_s2(input_pitch_1_sig);

    const short input_pitch_2_sig[] = { 0xD9, 0x5F, 0x10, 0x5F, 0x5E, 0x5D, 0x5B, 0x81, 0xC4, 0xA4, 0x00, 0x00, 0x00 };
    add_signature_s2(input_pitch_2_sig);

    const short reset_input_sig[] = { 0x89, 0x15, 0x9C, 0xD4, 0x6A, 0x0, 0x89 };
    add_signature_s2(reset_input_sig);

    const short select_item_jne_sig[] = { 0x75, 0x0D, 0xA0, -1, -1, -1, -1, 0x84, 0xC0, 0x0F, 0x84, 0x56, 0x01, 0x00, 0x00, 0x85, 0xF6, 0xC6, 0x05, -1, -1, -1, -1, 0x00 };
    add_signature_s2(select_item_jne_sig);
