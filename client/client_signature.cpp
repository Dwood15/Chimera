...
bool find_widescreen_fix_signatures() noexcept {
    ...
    const short console_text_fix_2_sig[] = { 0x66, 0x8B, 0x15, -1, -1, -1, -1, 0xD8, 0x4C, 0x24, 0x1C, 0xA1, -1, -1, -1, -1, 0x33, 0xC9, 0x66, 0x8B, 0x0D, -1, -1, -1, -1, 0xD9, 0x5C, 0x24, 0x1C, 0x66, 0xF7, 0xD9, 0x66, 0x03, 0xD1, 0xF7, 0xD8, 0x66, 0x8B, 0xEF, 0x2B, 0xFB, 0x66, 0x03, 0xE8, 0x66, 0x89, 0x54, 0x24, 0x12, 0x8D, 0x14, 0x38, 0x8A, 0x46, 0x0C, 0x81, 0xC1, 0x80, 0x02, 0x00, 0x00 };
...
bool find_simple_score_screen_sigs() noexcept {
    ...
    const short ss_elements_sig[] = { 0x66, 0xC7, 0x44, 0x24, 0x14, 0x19, 0x00, 0x66, 0xC7, 0x44, 0x24, 0x16, 0x5A, 0x00, 0x66, 0xC7, 0x44, 0x24, 0x18, 0x2C, 0x01, 0x66, 0xC7, 0x44, 0x24, 0x1A, 0x6D, 0x01, 0x66, 0xC7, 0x44, 0x24, 0x1C, 0xAE, 0x01, 0x66, 0xC7, 0x44, 0x24, 0x1E, 0xEF, 0x01, 0x66, 0xB8, 0x30, 0x02 };
    add_signature_s2(ss_elements_sig);

    const short ss_score_header_sig[] = { 0xE8, 0x0E, 0xDF, 0xFF, 0xFF, 0x8A, 0x44, 0x24, 0x23, 0x8B, 0x15 };
    add_signature_s2(ss_score_header_sig);
